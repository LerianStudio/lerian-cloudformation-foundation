...
echo "          MPS3BucketName=$S3_BUCKET \\"
echo "          MPS3BucketRegion=$AWS_REGION \\"
echo "          MPS3KeyPrefix=$S3_PREFIX \\"
echo "          ControlPlaneURL=https://api.lerian.studio \\"
echo "          EnrollmentToken=<token-from-the-console> \\"
echo "          AgentChartVersion=<agent-chart-version> \\"
