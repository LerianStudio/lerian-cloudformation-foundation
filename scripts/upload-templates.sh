...
echo ""
echo "  Put the full create-stack request, including EnrollmentToken, in a mode-600"
echo "  JSON file (see products/midaz/README.md). Then run:"
echo ""
echo "  aws cloudformation create-stack \\"
echo "      --cli-input-json file://foundation-create-stack.json \\"
echo "      --region $AWS_REGION"
echo ""
